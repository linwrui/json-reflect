...
exports.jsonFormat = exports.jsonPick = exports.jsonIgnore = exports.jsonReflect = exports.reflectToJson = void 0;
...
function reflect2json(key, value, context) {
    ...
    return typeof value === 'object' && (value === null || value === void 0 ? void 0 : value.hasOwnProperty('toJSON')) ? value.toJSON() : value;
}
function reflectToJson(obj) {
    return toJSON.call(obj);
}
exports.reflectToJson = reflectToJson;
